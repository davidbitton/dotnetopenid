//-----------------------------------------------------------------------
// <copyright file="SilverlightConsumer.cs" company="Andrew Arnott">
...
namespace DotNetOpenAuth.OAuth {
	...
	/// </remarks>
	public class SilverlightConsumer : ConsumerBase {
		/// <summary>
		/// Initializes a new instance of the <see cref="SilverlightConsumer"/> class.
		/// </summary>
		/// <param name="serviceDescription">The endpoints and behavior of the Service Provider.</param>
		/// <param name="tokenManager">The host's method of storing and recalling tokens and secrets.</param>
		public SilverlightConsumer(ServiceProviderDescription serviceDescription, IConsumerTokenManager tokenManager)
